...
The approach is presented in the paper titled "Efficient derivation of optimal signal schedules for multimodal intersections", authored by Nicola Bertocci, Laura Carnevali, Leonardo Scommegna, and Enrico Vicario, currently submitted to Simulation Modelling Practice and Theory.
